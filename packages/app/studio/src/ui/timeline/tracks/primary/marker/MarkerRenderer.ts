import {MarkerBoxAdapter, MarkerTrackAdapter} from "@naomiarotest/studio-adapters"
import {DefaultObservableValue, int, isDefined, Nullable, UUID} from "@naomiarotest/lib-std"
